...
--> statement-breakpoint
ALTER TABLE "agent_task_sessions" ADD COLUMN "working_memory_json" jsonb;--> statement-breakpoint
...
ALTER TABLE "heartbeat_runs" ADD COLUMN "input_tokens_normalized" integer;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "cached_tokens_normalized" integer;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "output_tokens_normalized" integer;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "task_session_reused" boolean;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "prompt_chars" integer;--> statement-breakpoint
