...
export const heartbeatRuns = pgTable(
  "heartbeat_runs",
  {
    ...
    inputTokensNormalized: integer("input_tokens_normalized"),
    cachedTokensNormalized: integer("cached_tokens_normalized"),
    outputTokensNormalized: integer("output_tokens_normalized"),
    taskSessionReused: boolean("task_session_reused"),
